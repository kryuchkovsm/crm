 ...
 */
'use strict';
angular.module('double-SiteIDe-select', [])
  .directive('crmDoubleSideSelect', ['$q', '$parse', function($q, $parse) {
    ...
    return {
      ...
      templateUrl: "components/directives/COMMON/doubleSideSelect/doubleSideSelectTpl.html",
