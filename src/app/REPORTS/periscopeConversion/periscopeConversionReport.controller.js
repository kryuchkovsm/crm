...
angular.module('crm')
  .controller('periscopeConversionReportCtrl', function (
  $scope, $state, ReportsSetup, $rootScope, GlobalVars, DataProcessing, $q, DataStorage, ScrollService) {
    ...
    var transactionGetDataPromise = function ($scope) {
      ...
      var action = 'periscope/conversion';
